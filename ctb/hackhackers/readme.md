...
Про первый [можно почитать тут](), а я расскажу про второй. Среди ханипотов много опций на 
выбор, я выбрал [kippo](https://github.com/desaster/kippo). В нём история логинов и паролей
хранится в БД MySQL, поэтому поставим и её. После запуска, сделаем запрос на сервер и посмотрим
таблицу `auth` в базе данных. Там видим шесть стандартных логинов и паролей, и один необычный:
`john:correcthorsebatterystaple` ([пароль взят из известной картинки с xkcd](https://xkcd.com/936/)).
